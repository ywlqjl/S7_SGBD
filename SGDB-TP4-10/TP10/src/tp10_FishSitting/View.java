...
/*
	...
	JMenu menuGroupeControl = new JMenu("GroupeControl");
	JMenu menuVasque = new JMenu("Vasque");
	JMenu menuEspece = new JMenu("Espece");
	JMenu menuTypologoe = new JMenu("Typologie");
